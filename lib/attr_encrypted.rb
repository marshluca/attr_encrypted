...
module AttrEncrypted
  ...
  module InstanceMethods
    ...
    #
    def attr_encrypted_attributes
      @attr_encrypted_attributes ||= self.class.attr_encrypted_attributes.dup
    end
    ...
    protected
      ...
      def evaluated_attr_encrypted_options_for(attribute)
        ...
        attribute_option_value = attr_encrypted_attributes[attribute.to_sym][:attribute]
        attr_encrypted_attributes[attribute.to_sym].map do |option, value|
